...
describe("Change the nullGetter", function () {
  ...
  it("should be possible to keep null tags as is", function () {
    ...
    return xmlTemplater.renderAsync({
      hobby: "diving"
    }).then(function () {
...
describe("Custom delimiters", function () {
  ...
  it("should work with loops", function () {
    ...
    expect(getContent(xmlt)).to.be.equal('<w:t xml:space="preserve">10</w:t><w:t xml:space="preserve"> 5</w:t><w:t xml:space="preserve"> </w:t>');
  });
...
describe("getting parents context", function () {
  it("should work with simple loops", function () {
    ...
    expect(getContent(xmlt)).to.be.equal('<w:t xml:space="preserve">Henry</w:t>');
  });
  it("should work with double loops", function () {
    ...
    expect(getContent(xmlt)).to.be.equal('<w:t xml:space="preserve">John Henry</w:t>');
  });
});