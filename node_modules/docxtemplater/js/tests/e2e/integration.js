  ...
  it("should correctly get the tags recursively using getObjectIdentifiers", function () {
    ...
    function addIdentifiers(tags) {
      for (var _i2 = 0; _i2 < tags.length; _i2++) {
        ...
        if (tag.cellParsed) {
          for (var _i4 = 0, _tag$cellParsed2 = tag.cellParsed; _i4 < _tag$cellParsed2.length; _i4++) {
            var cp = _tag$cellParsed2[_i4];
    ...
    function simplifyTags(tags) {
      var result = [];
      for (var _i6 = 0; _i6 < tags.length; _i6++) {
        var tag = tags[_i6];
        var part = null;
        if (tag.module === "pro-xml-templating/xls-module-sheetname") {
          continue;
