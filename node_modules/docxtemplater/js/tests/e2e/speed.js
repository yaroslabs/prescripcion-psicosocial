  ...
  describe("Speed test", function () {
    ...
    if (!process.env.FAST) {
      ...
      it("should not be slow when having many loops with resolveData", function () {
        ...
        var all = OldPromise.all.bind(OldPromise);
        var resolve = OldPromise.resolve.bind(OldPromise);
        ...
        return doc.resolveData(data).then(function () {
          ...
          expect(promiseResolveCount).to.be.within(total, total * 1.2);
          expect(promiseAllCount).to.be.within(total, total * 1.2);
        })["catch"](function (e) {
          global.Promise = OldPromise;
          throw e;
        });
